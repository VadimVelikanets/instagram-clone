    ...
    return (
        ...
        >
            <span className={styles.icon}>
                {drag ? (
                    <svg aria-label="Значок, соответствующий медиафайлам, например изображениям или видео" className="_8-yf5 "
                         color="#0095f6" fill="#262626" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
                        <path
