    ...
    return (
        <div className={styles.form}>
            ...
            <div className={styles.inputWrapper}>
                ...
                <Button disabled={isDisableSubmit} btnEvent={editProfileHandler} text={t('editPage.submit')} className={`${styles.submit} submit my-3 bg-blue-400 text-white py-1 px-4 rounded-md`} />
            </div>
        </div>
    );
};
